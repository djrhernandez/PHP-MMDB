                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header" data-background-color="purple">
                                <h4 class="title">Pharmacist List</h4>
                            ...
                            <div class="card-content">
                                <form>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                        $stid = oci_parse($link, 'SELECT * FROM CS3420.DHKW_PHARM_LIST');
                                    ...
                                    <a type="submit" href="addEmployee.php" value="Add Nurse" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Pharmacist</a>
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="./assets/img/faces/pharmacist-viewing-pills.jpg" />
                                </a>
                            </div>

                            <div class="content">
                                <h6 class="category text-gray">Pharmacist of the Year</h6>
                                <h4 class="card-title">Doug Baldwin</h4>
                                <p class="card-content">
                                    Yup! Just as I suspected, it's an opiate.
                                </p>
