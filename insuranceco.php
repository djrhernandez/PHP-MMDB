                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="purple">
                                <h4 class="title">Insurance Companies</h4>
                                <p class="category">Top 20 Insurance Coverage</p>
                            </div>
                                ...
                                <form>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th>Coverage</th>
                                            <th>Patient Covered</th>
                                            <th>Patient's Doctor</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        $stid = oci_parse($link, 'SELECT * FROM CS3420.DHKW_INSUR_LIST');
                                    ...
                                    <a type="submit" href="addEmployee.php" value="Add Nurse" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Insurance </a>
