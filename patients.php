...
<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="assets/img/faces/HeroesNeverdie.png">
        <!--
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    $stid = oci_parse($link, 'SELECT p.pid, p.name, p.dob, p.sex, p.phone_number, p.email  FROM CS3420.DHKW_PATIENTS p');
