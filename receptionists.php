                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header" data-background-color="purple">
                                <h4 class="title">Receptionist List</h4>
                            ...
                            <div class="card-content">
                                <form>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                        //Calls the Stored View
                                        $stid = oci_parse($link, 'SELECT * FROM CS3420.DHKW_REC_LIST');
                                    ...
                                    <a type="submit" href="addEmployee.php" value="Add Nurse" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Receptionist</a>
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="./assets/img/faces/angry-female-nurse.jpg" />
                                </a>
                            </div>

                            <div class="content">
                                <h6 class="category text-gray">Nurse</h6>
                                <h4 class="card-title">Top Nurse in the Country</h4>
                                <p class="card-content">
                                    Sometimes Patients are extremely difficult
                                </p>
