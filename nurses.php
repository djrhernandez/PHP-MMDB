                            ...
                            <div class="card-content">
                                <form>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                            $stid = oci_parse($link, 'SELECT * FROM CS3420.DHKW_NURSE_LIST');
                                    ...
                                    <a type="submit" href="addEmployee.php" value="Add Nurse" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Add Nurse </a>
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-avatar">
                                <a href="#pablo">
                                    <img class="img" src="./assets/img/faces/huuuuurrold.png" />
                                </a>
                            </div>

                            <div class="content">
                                <h6 class="category text-gray">HR Admin of the Quarter</h6>
                                <h4 class="card-title">Hide The Pain Harold</h4>
